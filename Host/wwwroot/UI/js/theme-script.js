        ...
        if (!e.isDefaultPrevented()) {
            ...
            $.ajax({
                ...
                success: function (data)
                {
                    ...
                    var alertBox = '<div class="alert alert-dismissable bg-white"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + messageText + '</div>';
...
jQuery('#waterdrop').raindrops({ color:'#6231EE', canvasHeight:150, density: 0.1, frequency: 20});
